        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl opacity-90">
              رحلة الدكتور أحمد العلواني في العمل السياسي والدفاع عن قضايا الشعب العراقي (2005-2014)
            </p>
          </div>
        </section>
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="default" className="text-sm px-3 py-1">
                      نائب في البرلمان العراقي (2005-2014)
                    </Badge>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    شغل الدكتور أحمد العلواني منصب نائب في البرلمان العراقي لدورتين متتاليتين من عام 2005 إلى عام 2014، 
                ...
                <div className="space-y-6">
                  <div className="border-r-4 border-iraqi-red pr-6">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      عُرف الدكتور العلواني خلال فترته البرلمانية (2005-2014) بموقفه المعارض والحازم من التدخلات الخارجية 
