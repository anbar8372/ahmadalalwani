        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl opacity-90">
              رحلة الدكتور أحمد العلواني في العمل السياسي والدفاع عن قضايا الشعب العراقي
            </p>
          </div>
        </section>
          ...
          <div className="space-y-8">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    يشغل الدكتور أحمد العلواني حالياً منصب نائب في البرلمان العراقي، 
                    كما يتولى رئاسة اللجنة الاقتصادية، حيث يعمل على وضع السياسات الاقتصادية 
                ...
                <div className="space-y-6">
                  <div className="border-r-4 border-iraqi-red pr-6">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      عُرف الدكتور العلواني بموقفه المعارض والحازم من التدخلات الخارجية في الشؤون العراقية، 
                      خاصة التدخل الإيراني. كان ينتقد بشدة السياسيين العراقيين الذين يعتبرهم موالين لإيران، 
                      ويدعو إلى استقلالية القرار العراقي.
                    </p>
                  </div>
                  
                  <div className="border-r-4 border-iraqi-green pr-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">النقد للحكومات السابقة</h3>
                    <p className="text-gray-700 leading-relaxed">
                      كان من أشد المنتقدين لحكومة رئيس الوزراء السابق نوري المالكي، حيث اتهمها 
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed text-lg">
                    ...
                    في الساحات الشعبية، وكانت له كلمة في كل مناسبة.
                  </p>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed text-lg">
                    كانت "قضية أهل السنة والجماعة، والإقليم السني" شغله الشاغل طيلة السنوات الماضية. 
                    أبرز هذه القضية بقوة في الفترة الأخيرة، استجابة لما يتعرض له المكون السني 
            ...
            <Card className="shadow-lg border-t-4 border-t-orange-500">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2 space-x-reverse text-2xl">
                  ...
                  <span>الاعتقال والقضايا القانونية</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    تم اعتقال الدكتور أحمد العلواني من منزله في الرمادي في فجر 28 سبتمبر 2013 
                    من قبل قوات الأمن العراقية بتهم "التحريض على الإرهاب". هذا الاعتقال أثار 
                    جدلاً واسعاً وردود فعل متباينة في الأوساط السياسية والشعبية.
                  </p>
                  <div className="bg-yellow-50 p-4 rounded-lg border-r-4 border-yellow-400">
                    <p className="text-gray-700">
                      <strong>ملاحظة:</strong> كان بعض السياسيين قد طالبوا برفع الحصانة عنه قبل اعتقاله، 
